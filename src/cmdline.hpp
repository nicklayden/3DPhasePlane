...
//         ("system.timemin",po::value<std::string>(), "initial 'time' value for integration")
//         ("system.timemax",po::value<std::string>(), "maximum time value")
//         ("system.dt",po::value<std::string>(), "time step")
